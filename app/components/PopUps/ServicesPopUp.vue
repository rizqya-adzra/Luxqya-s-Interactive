  ...
  <transition name="fade">
    <div v-if="open" class="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <transition name="slide">
        <div
          class="relative bg-primary rounded-3xl w-[1260px] h-[730px] p-12 flex justify-center items-center z-50 shadow-xl overflow-y-auto outline-4 outline-secondary outline-dashed outline-offset-[-25px]"
          @click.stop
        >
          <div class="flex">
            <div class="bg-secondary w-[580px] h-[630px] p-10 flex flex-col gap-6 rounded-l-lg overflow-y-auto">
              <ButtonsLanguageSwitchButton/>
              <div>
                <p class="font-playfair font-bold text-3xl">1. Copyrights</p>
              ...
              <div>
                <p class="font-playfair font-bold text-3xl">2. Payment</p>
                <div class="font-poppins mt-2">
                  <ul class="list-disc pl-5 space-y-1">
            ...
            <div class="bg-tertiary w-[580px] h-[630px] p-12 flex flex-col gap-6 rounded-r-lg overflow-y-auto">
              <div>
                <p class="font-playfair font-bold text-3xl">3. Pricing</p>
                <div class="font-poppins mt-2">
                  <ul class="list-disc pl-5 space-y-1">
